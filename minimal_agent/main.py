...
from .agent import get as get_agent
from .analysis import AnalysisService
from .config import AgentConfig
from .lsp.server import LspPool
from .model import OpenAIModelAdapter
from .project import Project
from .runtime.loop import run as run_loop
from .session.store import SessionStore
from .tool.registry import ToolRegistry
from .types import RunInput


app = typer.Typer(help="Minimal end-to-end ReAct agent CLI")
console = Console()
...
def run(
    ...
    cfg = AgentConfig.load(
        project.cwd,
        env_search_paths=[project.root, project.cwd],
